        ...
        <div className="px-8">
          <div className="grid items-center gap-4 lg:grid-cols-4">
            ...
            <div className="mb-4 flex flex-col items-center gap-2 md:flex-row lg:col-span-3">
              {data.rounds?.map((item: any, i: number) => (
                <div className="group flex grow items-center">
                  <button
          ...
          <div className="grid">
            {data.rounds[activeTab].hubs?.map((hub: any, index: number) => (
              <div
                key={`hub-${index}`}
              ...
              >
                <div className="font-pp flex items-center justify-between gap-4 border-gray-200/30 py-4 text-3xl md:flex-col md:items-start md:justify-start md:border-r">
                  ...
                  <div className="flex gap-4">
                    {hub.logos.map((logo: any, i: number) => (
                      <img key={i} src={urlFor(logo).url()} className="w-12" />
                    ))}
                  </div>
                </div>
                <div className="flex flex-col lg:col-span-3">
                  {hub.projects?.map((p: any, i: number) => (
                    <div
                      key={i}
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex gap-4">
                          <a href={hub.github} target="_blank">
                            <svg
                              width="24"
                              height="23"
                              viewBox="0 0 24 23"
